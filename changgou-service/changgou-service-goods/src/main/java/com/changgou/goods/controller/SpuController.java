...
public class SpuController {
    ...
    public Result<Goods> findGoodsById(@PathVariable Long id){
        Goods goods = spuService.findByGoodsId(id);
        return new Result<>(true,StatusCode.OK,"查询成功",goods);
    }
    @DeleteMapping("/logic/delete/{id}")
    public Result LogicDeleteById(@PathVariable("id") Long id){
        spuService.LogicDeleteById(id);
        return new Result(true,StatusCode.OK,"逻辑删除成功");
    }

    @PutMapping("/pull/{id}")
    public Result pullById(@PathVariable("id") Long id){
        spuService.pullById(id);
        return new Result(true,StatusCode.OK,"下架成功");
    }
    @PutMapping("/put/{id}")
    public Result putSpu(@PathVariable("id") Long id){
        spuService.putSpu(id);
        return new Result(true,StatusCode.OK,"上架成功");
    }
    @PutMapping("/restore/{id}")
    public Result restoreSpu(@PathVariable("id") Long id){
